...
<body>
               <br>
            <center><h3>Consulte sua empresa aqui</h3></center>
                <br>
<label>CNPJ</label>
                 <input type="text" placeholder="Digite seu CNPJ" onblur="checkCnpj(this.value)" data-mask="00.000.000/0000-00" class="form-control" />
           </div>
        </div>
